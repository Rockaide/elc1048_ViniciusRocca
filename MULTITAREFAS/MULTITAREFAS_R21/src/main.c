...
#define TAM_PILHA_NEW_TASK	(TAM_MINIMO_PILHA + 24)
...
uint32_t PILHA_NEW_TASK[TAM_PILHA_NEW_TASK];
...
int main(void)
{
	...
	CriaTarefa(new_task, "New Task", PILHA_NEW_TASK, TAM_PILHA_NEW_TASK, 3);
